...
const site = {
  ...
  description:
    'گروه تولیدی صنعتی فولاد ایمان، تولید و فروش انواع قوطی، پروفیل، نبشی، رابیتس، ' +
    'شاخ گوزنی، فنس، ایزوگام و گل و طرح‌های فرفورژه در علی‌آباد کتول و گرگان، استان گلستان.',
  ...
  address: {
    ...
    country: 'ایران',
    street: 'علی‌آباد کتول، استان گلستان',
  },
