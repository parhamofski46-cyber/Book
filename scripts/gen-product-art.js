...
/* ══════════ رابیتس: شبکه‌ی رومبی با تراکم متفاوت ══════════ */
...
const MAP = {
  ...
  'رابیتس ۹ ستون': () => rabis(9, false),
  'رابیتس ۱۳ ستون ۷۰۰ گرم': () => rabis(13, false),
  'رابیتس ۱۳ ستون ۹۰۰ گرم': () => rabis(13, true),
  // شاخ گوزنی حالا فقط یک مدل دارد (ارتفاع ۹۰ سانتی‌متر، جوش CO2) و عکس
  // واقعی‌اش در public/img/photos هست، پس به تصویرسازی نیازی ندارد.
  'شاخ گوزنی ۹۰ سانتی‌متر': () => shakh(3, false),
  'تور مرغی': () => fence('hex'),
